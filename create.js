...
async function makeMyNFT() {
    ...
    try {
        ...
        document.getElementById("TrxResult").innerHTML = "Transaction Initiated<br><br>" + "Transaction ID : " + txHash + "<br>Immediately please copy this Transaction ID to a safe location.<br>" + "Track at our Verify page: <a href='https://blockcertifyproject.github.io/verify.html' target='_blank'>Verify</a>";
        document.getElementById("TrxResult").style.display = "inline";
        console.log(txHash);
